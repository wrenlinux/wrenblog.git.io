    ...
    <footer>
                ...
                <h2 class="brand"><a href="index.php"> Fr<span style="color: #ff591cbb">o</span>nt-Page </a></h2>
...
setInterval(GetClock,1000);
                ...
                <p class="footer-terms">Copyright &copy; <script>document.write(new Date().getFullYear())</script> Frontpage. All right reserved</p>
              </footer>