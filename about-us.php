...
<html lang="en">
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/png">
        ...
        <meta name="keywords" content="about, us, bio, News, trending, media, magazine, gossip, celebrities, lessons ,references,examples,tips, videos, beginners, free">
...
?>
      ...
      <div class="row">
      <div class="col-lg-6">
          <img class="img-fluid rounded mb-4" src="logo-dock.png" alt="image">
        </div>
        <div class="col-lg-6">
